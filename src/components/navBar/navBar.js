            ...
            user ? (
              <>
                <span onClick={() => setIsLogoutModalOpen(true)}
                  className="px-4 py-2 rounded-full bg-white border border-neutral-300 text-black text-sm hover:bg-teal-500 hover:text-white transition">Log Out</span>
              </>
            ) : (
              <Link href="/login" className="px-4 py-2 rounded-full bg-white border border-neutral-300 text-black text-sm hover:bg-teal-500 hover:text-white transition">Log In</Link>
            )
          } <Link
            href="/pricing"
