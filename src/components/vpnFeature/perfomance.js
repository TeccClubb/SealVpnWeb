...
export default function Performance() {
    return (
        <div className="bg-gray-100  text-black px-6 py-12 md:py-20">
            ...
            <h2 className="text-center text-2xl md:text-3xl font-semibold mb-10">Performance</h2>
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div className="grid grid-rows-3 gap-8">
                    <div className="text-center">
                        ...
                        <p className=" text-center justify-start text-neutral-500 text-lg font-normal font-['Montserrat'] leading-relaxed mt-2">
                    ...
                    <div className="row-span-2 flex items-center justify-center">
                        <Image
                            src="/vpnfeatureImg/performanceImg.png" // replace with your image
                ...
                <div className="flex flex-col gap-8">
                    <div className="text-center">
                        ...
                        <p className=" mt-2  text-center justify-start text-neutral-500 text-lg font-normal font-['Montserrat'] leading-relaxed">
                ...
                {/* Right Column (top box + image below) */}
